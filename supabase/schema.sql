...
begin
  ...
  -- वार्ड 12 में एक IP ने 98 वोट और वार्ड 5 में एक IP ने 41 वोट सिर्फ़ एक
  -- प्रत्याशी को दिए, हर बार नया device_hash बनाकर (fingerprint बदलने वाला
  -- ब्राउज़र) — पर वार्ड-स्तर की 400 वाली सीमा के अंदर ही रहे, इसलिए पकड़ में
  -- नहीं आए। साफ़ होने के बाद जाँचा तो सभी 25 वार्डों में असली वोट/IP अनुपात
  -- 1.3 से ऊपर कभी नहीं गया — इसलिए 3 पूरी तरह सुरक्षित सीमा है, किसी असली
  -- साझा नेटवर्क को यह कभी नहीं छूती।
  select count(*) into v_ipchoice from public.votes
   where ward = p_ward and choice = p_choice and ip_hash = p_ip;
  if v_ipchoice >= 3 then
    return json_build_object('ok', false, 'code', 'rate');
  end if;
