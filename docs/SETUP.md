...
## 🛡️ VPN/डेटासेंटर IP ब्लॉक (6 सितम्बर से)

Edge Function अब AWS, Google Cloud और Oracle Cloud की सार्वजनिक IP-list के
ख़िलाफ़ हर वोट का IP जाँचता है — कोई paid service नहीं, list अपने आप हर
12 घंटे में ताज़ा होती है, function के ज़िंदा रहते हुए (कोई cron/SQL नहीं
चाहिए, सिर्फ़ कोड में है)।

सस्ते/मुफ़्त VPN और automated bot ज़्यादातर इन्हीं तीन cloud providers पर
चलते हैं — कोई असली भारतीय Jio/Airtel मोबाइल user कभी इनकी list में नहीं
आता। मैच होने पर वोट रुक जाता है, संदेश: *"VPN बंद करके कोशिश करें।"*

**ईमानदारी से सीमा:** यह हर VPN नहीं पकड़ता — कुछ महंगी/निजी VPN सेवाएँ
residential IP (असली घरों के कनेक्शन) किराए पर लेती हैं, जो इस list में
नहीं आतीं और पकड़ में नहीं आएँगी। पर बड़ा हिस्सा (सस्ते/मुफ़्त VPN ऐप,
ज़्यादातर automated bot) यहीं रुक जाता है। कुछ बदलने की ज़रूरत नहीं —
